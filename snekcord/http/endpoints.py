...
class HTTPEndpoint:
    def __init__(self, method, url):
        self.method = method
        self.url = url
        self.keywords = [key[1] for key in _formatter.parse(url) if key[1] is not None]
