...
class BaseMapping(Generic[KT, VT]):
    ...
    @classmethod
    def for_type(
        cls, klass: type[MutableMapping[KT, VT]]
...
class BaseSnowflakeMapping(BaseMapping[Snowflake, VT]):
    ...
    def __setitem__(self, key: SnowflakeConvertable, value: VT) -> None: ...
    def get(
        self, key: SnowflakeConvertable, default: DT
    ) -> SnowflakeConvertable | DT: ...
    @overload
...
class WeakValueSnowflakeMapping(
    BaseSnowflakeMapping[VT], WeakValueDictionary[Snowflake, VT]
): ...

class _StateCommon(Generic[KT]):
    def __contains__(self, key: BaseObject[KT]) -> bool: ...
    def find(
        self, func: Callable[[BaseObject[KT]], bool]
